...
import { preferencesSections, quickPresets } from '@/data/userSettings'
import {
  GeneralSettings,
  ThemeSelector, 
  LanguageSettings,
...
const PreferencesPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme.background} relative`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className={`absolute top-1/2 left-10 w-24 h-24 bg-gradient-to-br ${theme.secondary} rounded-lg opacity-15 blur-lg animate-pulse-glow animation-delay-2000`}></div>
