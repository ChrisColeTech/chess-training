...
// Removed mock data imports - now provided by useNotifications hook
  ...
  return (
    <div className="min-h-full p-4 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className={`absolute top-1/2 right-10 w-24 h-16 bg-gradient-to-br ${theme.highlight} rounded-full opacity-15 blur-lg animate-pulse-glow animation-delay-2000`}></div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="alerts" className="space-y-6">
            <AlertSettings
              ...
              availableSounds={detailedSoundOptions}
              onPreviewSound={previewSound}
              visualAlertOptions={visualAlertOptions}
              priorityLevelOptions={detailedPriorityLevelOptions}
              theme={theme}
            />
          </TabsContent>
