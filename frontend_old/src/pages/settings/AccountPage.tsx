...
// Available subscription tiers - moved here to remove dependency on @/data
const availableSubscriptionTiers = [
  {
    id: 'free',
    name: 'Free',
    price: { monthly: 0, yearly: 0 },
    features: ['Basic puzzles', 'Limited analysis', 'Community access'],
    limits: { puzzles: 10, analysis: 1 },
    current: true
  },
  {
    id: 'premium',
    ...
    features: ['Unlimited puzzles', 'Advanced analysis', 'Premium support'],
    limits: { puzzles: -1, analysis: -1 },
    current: false
  },
  {
    id: 'pro',
    ...
    features: ['Everything in Premium', 'AI coaching', 'Custom training plans'],
    limits: { puzzles: -1, analysis: -1 },
    current: false
  }
]
