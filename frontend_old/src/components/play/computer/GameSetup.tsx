...
// Time control configurations moved locally
const timeControlConfigs: TimeControlConfig[] = [
  {
    initialTime: 1,
    increment: 0,
    type: 'Blitz',
    displayName: '1+0 Bullet',
    description: 'Lightning-fast games for quick battles'
  },
  {
    initialTime: 3,
    increment: 0,
    type: 'Blitz',
    displayName: '3+0 Blitz',
    description: 'Fast-paced tactical combat'
  },
  {
    initialTime: 5,
    increment: 0,
  ...
  },
  {
    ...
    description: 'Time to think with increment bonus'
  },
  {
    initialTime: 30,
    increment: 0,
    type: 'Classical',
    displayName: '30+0 Classical',
    description: 'Deep strategic planning time'
  },
  {
    initialTime: 0,
    increment: 0,
