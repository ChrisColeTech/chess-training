...
import { FolderOpen, Search, Plus, Trash, Upload } from 'lucide-react'
import { Crown, Target, Zap, Book } from 'lucide-react'

// Category icon utility moved locally
const getCategoryIcon = (category: string) => {
  switch (category) {
    case 'Tactical': return Target
    case 'Strategic': return Crown
    case 'Endgame': return Zap
    case 'Opening': return Book
...
export const PositionDatabase: React.FC<PositionDatabaseProps> = ({
  ...
  // Use extracted category icon function
