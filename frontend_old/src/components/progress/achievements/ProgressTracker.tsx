...
const progressTrackerSizeConfig = {
  small: {
    height: 'h-1',
    textSize: 'text-xs',
    spacing: 'mb-1'
...
export const ProgressTracker: React.FC<ProgressTrackerProps> = ({
  ...
  const config = progressTrackerSizeConfig[size]
    ...
    <div className="w-full">
      ...
      <div className={`w-full bg-slate-700/50 rounded-full overflow-hidden ${config.height}`}>
        ...
        >
          ...
          {percentage >= progressBarConfig.thresholds.highProgress && (
      ...
      {target >= 100 && (
        <div className="flex justify-between mt-1">
          {progressBarConfig.milestoneMarkers.map(milestone => {
      ...
      {percentage >= progressBarConfig.thresholds.nearCompletion && percentage < progressBarConfig.thresholds.completion && (
      ...
      {percentage === progressBarConfig.thresholds.completion && (
        <div className="text-center mt-1">
