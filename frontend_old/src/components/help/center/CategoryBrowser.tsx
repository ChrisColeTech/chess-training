...
import { ArrowRight, Star, TrendingUp, Puzzle, BookOpen, Settings, HelpCircle, Trophy, Users } from 'lucide-react'
import { Card } from '@/components/ui/card'
import { Badge } from '@/components/ui/badge'
import type { CategoryBrowserProps, HelpCategory } from '@/types/helpCenter'

// Local constants for category icons instead of importing from @/data
const categoryIcons = {
