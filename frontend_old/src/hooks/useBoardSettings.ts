...
const defaultBoardTheme: BoardTheme = {
  ...
  description: 'Classic wood board theme',
  category: 'Classic',
  isUnlocked: true,
  createdAt: 0
}

const allBoardThemes: BoardTheme[] = [
  defaultBoardTheme,
  {
    id: 'green',
    name: 'Green',
...
const sampleCustomThemes: BoardTheme[] = []

const findThemeById = (id: string): BoardTheme | undefined => {
